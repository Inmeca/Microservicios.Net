...
namespace Example.Catalogos.Test.Facade
{
    ...
    public class FacadeTest : BaseTest
    {
        ...
        {
            // Act
            var response = await this.modelFacade.DeleteCatalogos(2);
            var find_result = await this.modelFacade.GetListCatalogosActive(2);
